...
export const Footer = () => {
  return (
    <div className='flex items-center justify-between w-full  px-20 text-center bg-gradient-to-r from-[#060B1B] to-[#04100B] h-[150px]'>
        {/* <span className='w-1/4 text-start text-white text-sm font-light uppercase tracking-widest '>Made with ❤️ by XLBR </span> */}
        <div><img src="./footer_logo.png" className="h-[50px]" alt="logo" /></div>

...
export const Footer = () => {
  return (
    <div className='flex items-center justify-between w-full  px-20 text-center bg-gradient-to-r from-[#060B1B] to-[#04100B] min-h-20'>
        ...
        <span className='w-1/4 text-end text-gray-400 text-[10px] font-light uppercase tracking-widest '>All charcaters are AI generated and the website does not take any responsibility for the accuracy.</span>
    </div>
  )
}
